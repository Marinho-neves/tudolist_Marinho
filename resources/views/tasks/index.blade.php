...
<form method="POST">
  ...
  <div class="mb-3">
    ...
    <input value="{{ @old('name') }}" name='name' type="text" class="form-control" placeholder="Nome da Tarefa">
    @error('name')
  ...
  <div class="mb-3">
    ...
    <textarea name="description" cols='2' class="form-control" placeholder="Descrição da Tarefa">{{ @old('description') }}</textarea>
    @error('description')
      <div class="form-text">{{$message}}</div>
    @enderror
  </div>
